...
(
  ...
  FOREIGN KEY (id_department) REFERENCES department(id_department),
  FOREIGN KEY (id_instructor) REFERENCES instructor(id_instructor)
); -- Essa alteração permite que as notas dos alunos em cada curso sejam armazenadas na mesma tabela que as 
--informações de matrícula. No entanto, é importante lembrar que isso pode resultar em uma tabela maior e mais lenta 
--de ser consultada, caso haja muitas matrículas e notas para armazenar.
...
INSERT INTO instructor (id_instructor, employment_status, hire_date, person_type)
VALUES (2, 'Part-time', TO_DATE('2022-02-15', 'YYYY-MM-DD'), 'instructor');

INSERT INTO instructor (id_instructor, employment_status, hire_date, person_type)
VALUES (3, 'Full-time', TO_DATE('2022-03-10', 'YYYY-MM-DD'), 'instructor');
...
VALUES (1, 'IT', 'Active', '123456');

INSERT INTO department (id_department, name, status, caixa_postal)
VALUES (2, 'Finance', 'Active', '789012');

INSERT INTO department (id_department, name, status, caixa_postal)
VALUES (3, 'Marketing', 'Inactive', '345678');
...
INSERT INTO course (id_course, credits, name, description, id_department, id_instructor)
VALUES (2, 3, 'Physics', 'Fundamentals of Physics', 1, 2);

INSERT INTO course (id_course, credits, name, description, id_department, id_instructor)
VALUES (3, 3, 'Chemistry', 'Basic Chemistry Principles', 2, 3);
...
VALUES ('Enrolled', TO_DATE('2023-01-15', 'YYYY-MM-DD'), 1, 1);

INSERT INTO student_enrollment (enrollment_status, enrollment_date, id_student, id_course)
VALUES ('Enrolled', TO_DATE('2023-02-01', 'YYYY-MM-DD'), 1, 2);

INSERT INTO student_enrollment (enrollment_status, enrollment_date, id_student, id_course)
VALUES ('Enrolled', TO_DATE('2023-01-20', 'YYYY-MM-DD'), 2, 1);
